...
ISR(ADC_vect)
{
    ...
    static uint8_t line = 0;                // Constant for LCD lines (0-15)                              | uint8_t range is 0 to 255
    static uint8_t column = 0;              // Constant for LCD columns (0-1)
    static uint8_t marker = 0;              // One time using constant for position of first symbol 
    static uint8_t symbol = 0x2a;           // Symbol value
